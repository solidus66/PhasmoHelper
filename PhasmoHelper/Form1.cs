    ...
    public partial class Form1 : Form
    {
        ...
        private void InitializeGhostDescriptions()
        {
            ghostDescriptions = new Dictionary<string, string>
            {
                ...
                { "Морой", "Много рассудка - медленный, мало рассудка - очень быстрый. Ускоряться начинает от 45% рассудка и ниже." },
                { "Деоген","Может охотиться от 40% рассудка и ниже. От него невозможно спрятаться. Он очень быстр, когда не видит цель, но подходя ближе становится медленным настолько, что от него можно уйти пешком." },
